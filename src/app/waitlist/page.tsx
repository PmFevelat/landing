...
export default function WaitlistPage() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    try {
      ...
      toast.success('Inscription à la liste d\'attente effectuée avec succès !', {
        duration: 5000,
        closeButton: true,
      });
      form.reset();
      ...
      toast.error('Une erreur est survenue lors de l\'inscription.', { duration: 5000, closeButton: true });
    }
  }
              ...
              <div className="container max-w-2xl mx-auto px-6 pb-24">
                <div className="text-center mx-auto max-w-xl">
                  ...
                  <p className="text-lg text-muted-foreground mb-12">
                    Be among the first to access our secure benchmarking platform.
                  </p>
                </div>
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 bg-white/50 backdrop-blur-sm p-8 rounded-2xl shadow-sm">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-foreground/90">Message (optional)</FormLabel>
                          <FormControl>
                            <Textarea
                              placeholder="Share your needs or questions with us..."
                    ...
                    />
                    <Button type="submit" className="w-full py-6 text-base">Join the Waitlist</Button>
                  </form>
                </Form>
              </div>
            </div>
